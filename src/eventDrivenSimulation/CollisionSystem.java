...
public class CollisionSystem {
    ...
    public void simulate(double limit) {
        ...
        while (!pq.isEmpty()) {
            ...
            for (int i = 0; i < particles.length; i++) {
                if (particles[i].color != Color.WHITE) {
    ...
    private static class Event implements Comparable<Event> {
        ...
        private boolean removed(Particle p) {
            return p != null && p.color == Color.WHITE;
        }

        // has any collision occurred between when event was created and now?
        public boolean isValid() {
            if(removed(a) || removed(b)) return false;
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 1) {
            ...
            particles[0] = new MyParticle(0.1, 0.1, 0.005, 0.005, 0.02, 0.5, Color.RED);
            particles[1] = new MyParticle(0.9, 0.9, 0.010, 0.010, 0.02, 0.5, Color.GREEN);
        }
